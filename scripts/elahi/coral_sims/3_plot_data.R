...
ggsave("scripts/elahi/coral_sims/figs_sims/oasis_z_plot.png", height = 5, width = 6)
ggsave("scripts/elahi/coral_sims/figs_sims/oasis_z_plot.pdf", height = 5, width = 6)
